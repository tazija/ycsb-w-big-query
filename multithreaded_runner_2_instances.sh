...
function printHelp () {
  echo "Usage: "
  echo "  ./multithreaded_runner_2_instances.sh -w <workload_name> -d <database_name> -p arg1=argvalue1 -p arg2=argvalue2"
  echo "  ./multithreaded_runner_2_instances.sh -h|--help (print this message)"
...
for threads in 25 50 75 100 125 150 200 250 300 400; do
